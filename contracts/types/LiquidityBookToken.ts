...
export interface LiquidityBookTokenInterface extends utils.Interface {
  functions: {
...
export type OracleSizeIncreasedEvent = TypedEvent<
  [BigNumber, BigNumber],
  OracleSizeIncreasedEventObject
>;

export type OracleSizeIncreasedEventFilter =
  TypedEventFilter<OracleSizeIncreasedEvent>;
...
export type ProtocolFeesCollectedEventFilter =
  TypedEventFilter<ProtocolFeesCollectedEvent>;
...
export type WithdrawnFromBinEventFilter =
  TypedEventFilter<WithdrawnFromBinEvent>;

export interface LiquidityBookToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityBookTokenInterface;
  ...
  functions: {
    ...
    feeParameters(
      overrides?: CallOverrides
    ): Promise<[FeeHelper.FeeParametersStructOutput]>;
    ...
    getBin(
      ...
      [BigNumber, BigNumber] & { reserveX: BigNumber; reserveY: BigNumber }
    >;
  ...
  callStatic: {
    ...
    mint(
      ...
      [BigNumber, BigNumber, BigNumber[]] & { liquidityMinted: BigNumber[] }
    >;
    ...
    swap(
      ...
      [BigNumber, BigNumber] & { amountXOut: BigNumber; amountYOut: BigNumber }
    >;
  ...
  filters: {
    ...
    "OracleSizeIncreased(uint256,uint256)"(
      previousSize?: null,
      newSize?: null
    ): OracleSizeIncreasedEventFilter;
    OracleSizeIncreased(
      previousSize?: null,
      newSize?: null
    ): OracleSizeIncreasedEventFilter;
