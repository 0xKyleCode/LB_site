...
import type {
  LBVaultV1Native,
  LBVaultV1NativeInterface,
} from "../LBVaultV1Native";
...
export class LBVaultV1Native__factory {
  static readonly abi = _abi;
  static createInterface(): LBVaultV1NativeInterface {
    return new utils.Interface(_abi) as LBVaultV1NativeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LBVaultV1Native {
    return new Contract(address, _abi, signerOrProvider) as LBVaultV1Native;
  }
}
