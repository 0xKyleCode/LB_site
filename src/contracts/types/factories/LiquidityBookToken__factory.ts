...
import type {
  LiquidityBookToken,
  LiquidityBookTokenInterface,
} from "../LiquidityBookToken";
...
export class LiquidityBookToken__factory {
  static readonly abi = _abi;
  static createInterface(): LiquidityBookTokenInterface {
    return new utils.Interface(_abi) as LiquidityBookTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LiquidityBookToken {
    return new Contract(address, _abi, signerOrProvider) as LiquidityBookToken;
  }
}
